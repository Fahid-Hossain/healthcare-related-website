    ...
    return (
        <div>
                ...
                <div id="" className="container mx-auto">
                    <div className="text-white py-24 px-10 object-fill banner h-5/6">
                        <div className="md:w-1/2">
                            ...
                            <Link to="/" className="bg-purple-700 py-4 px-8 text-white font-bold uppercase text-xs rounded hover:bg-purple-800 hover:text-white-800">Contact us</Link>
                        </div>
                    </div>
                    <br />
                </div>
            ...
            <div className="flex justify-between w-12 mx-auto pb-2">
                ...
                <button id="sButton2" onclick="sliderButton2() " className="bg-blue-400 rounded-full w-4 p-2"></button>
            </div>
        </div>
    );
};
